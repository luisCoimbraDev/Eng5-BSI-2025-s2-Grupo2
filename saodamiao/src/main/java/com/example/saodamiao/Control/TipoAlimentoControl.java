...
public class TipoAlimentoControl {
    ...
    public ResponseEntity<Object> InsereTipoAlimento(@RequestBody TipoAlimentoDTO tipoAlimento){
        ...
        if(t1.getTipoAlimentoDAO().gravar(t1, Singleton.Retorna())){
    ...
    public ResponseEntity<Object> allTipos(){
        ...
        List<TipoAlimentoDTO> listaTipoAlimento = dto.listToDTO(t1.getTipoAlimentoDAO().pegarListaToda(Singleton.Retorna()));
